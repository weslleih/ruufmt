...
public class Meal extends Card implements Serializable {
    ...
    public void setUpRating(int upRating) {
    ...
    public void setDownRating(int downRating) {
